...
def load_encoder():
    if os.path.isdir("encoder"):
        ...
        encoder = keras.Sequential([
            ...
            layers.Conv2D(32, 5, activation="sigmoid"),
            layers.Conv2D(32, 5, activation="sigmoid"),
...
def load_decoder():
    if os.path.isdir("decoder"):
        ...
        decoder = keras.Sequential([
            layers.Reshape(ENCODE_SHAPE),
            layers.Conv2DTranspose(64, 3, activation="sigmoid"),
            layers.Conv2DTranspose(32, 3, activation="sigmoid"),
            layers.Conv2DTranspose(32, 5, activation="sigmoid"),
            layers.Conv2DTranspose(32, 5, activation="sigmoid"),
